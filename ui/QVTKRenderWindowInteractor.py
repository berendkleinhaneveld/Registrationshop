...
Changes by Rodrigo Mologni, Sep. 2013 (Credit to Daniele Esposti)
 Bug fix to PySide2: Converts PyCObject to void pointer.
    ...
    try:
        ...
        try:
            ...
            try:
                ...
                raise ImportError("Cannot load either PyQt or PySide2")
