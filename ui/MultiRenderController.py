...
class MultiRenderController(QObject):
    ...
    def __init__(self, mulitRenderWidget):
        ...
        self.visualizations = (
            dict()
        )  # Dict of MultiVolumeVisualizations, visType as keys
    ...
    def setVisualizationType(self, visualizationType):
        ...
        if (
            self.visualizationType is None
            or visualizationType not in self.visualizationTypes
        ):
        ...
        if self.visualizationType in self.visualizations:
            ...
            self.visualization = MultiVolumeVisualizationFactory.CreateProperty(
