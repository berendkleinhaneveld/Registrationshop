...
from ui.transformations import Transformation, TransformBox
...
class UserTransformationTool(TransformationTool):
    ...
    def setRenderWidgets(self, fixed=None, moving=None, multi=None):
        ...
        self.renderWidget.transformations.append(
            Transformation(
                vtkTransform(), Transformation.TypeUser, currentProject.movingData
            )
        )
        ...
        statusWidget.setText(
            ...
            "For more specific control of the transformation, "
            "use the matrix values to specify the transform."
        )
