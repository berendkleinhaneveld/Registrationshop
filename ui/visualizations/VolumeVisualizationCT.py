...
class VolumeVisualizationCT(VolumeVisualization):
    ...
    def __init__(self):
        ...
        # Just like opacity should be tweaked. A section can
        # have any slope / configuration
        self.sectionColors = [
            (1.0, 1.0, 1.0),
            (0.0, 1.0, 0.0),
            (1.0, 0.9, 0.8),
    ...
    def updateTransferFunction(self):
        ...
        for x in range(len(self.sections) - 1):
            ...
            self.opacityFunction.AddPoint(
                self.sections[x + 1] - 0.05, self.sectionsOpacity[x]
            )
    ...
    def getParameterWidget(self):
        ...
        for index in range(7):
            ...
            slider.setValue(
                int(math.pow(self.sectionsOpacity[index], 1.0 / 3.0) * slider.maximum())
            )
